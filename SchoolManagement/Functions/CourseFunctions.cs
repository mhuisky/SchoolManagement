...
namespace SchoolManagement.Functions
{
    ...
    {
        public static void CourseManagement(int Selection, School School, string coursePath, List<Course> AllCourses)
        {
            ...
            switch (Selection)
            {
                case 1:
                    ...
                    School.AddToSchool(newCourse);
                    GeneralFunctions.JsonSerialization.WriteToJsonFile<List<Course>>(coursePath, School.Courses);
